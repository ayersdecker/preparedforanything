...
export default function Login() {
  const { signIn, signInWithGoogle, userProfile, isDemoMode } = useAuth();
  ...
  const redirect = (profile: typeof userProfile) => {
      ...
      <div className="min-h-screen flex items-center justify-center bg-background px-4">
        <div className="w-full max-w-md bg-surface border border-surface-2 rounded-modal p-8 text-center">
          ...
          <p className="text-text-secondary mb-6">
            ...
            Configure your <code className="text-primary">.env</code> file with Firebase credentials to enable authentication.
          </p>
